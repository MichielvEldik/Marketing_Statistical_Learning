...
## What is the lag distirbution?
The lag distribution is a graph with Beta values for all lags of a variable (y-axis), over its corresponding lag value (x). It tells us the impact of changes in independent variables in each period. 
